...
sim.test.neg.cluster3<-function(network,m,power,n.sim){
  ...
  for (i in 1:n.sim){
    ...
    fnr.n<-c(fnr.n,vcount(module.n))
    fnr.e<-c(fnr.e,vcount(module.e))
...
resultneg.sim11<-sim.test.neg.cluster2(network,,p=0.3,n.sim=10)
resultneg.sim12<-sim.test.neg.cluster2(network,p=0.1,n.sim=10)
...
resultabneg.sim11<-sim.test.neg.cluster3(network,m=24,power=1,n.sim=10)
resultabneg.sim12<-sim.test.neg.cluster3(network,m=24,power=3,n.sim=10)

resultabneg.sim21<-sim.test.neg.cluster3(network,m=77,power=1,n.sim=10)
resultabneg.sim22<-sim.test.neg.cluster3(network,m=77,power=3,n.sim=10)
